...
import 'mod_view_profile.dart';

class ModSearchPage extends StatefulWidget {
  const ModSearchPage({super.key});

  @override
  State<ModSearchPage> createState() => _ModSearchPageState();
}

class _ModSearchPageState extends State<ModSearchPage> {
            ...
            _userName.isNotEmpty && _userUid.isNotEmpty
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ModViewProfile(followerId: _userUid),
                  ),
                );
              },
              child: Text(
